    ...
    <div className='flex justify-center items-center bg-slate-100 min-h-screen'>
      <div className='flex w-[90%] max-w-5xl shadow-lg rounded-2xl overflow-hidden bg-white'>
        ...
        <div className='w-1/2 p-8 flex flex-col justify-center'>
          <h1 className='text-3xl font-bold text-center mb-6 text-green-600'>Sign In</h1>
          <p className='text-center font-medium'>Sign in to continue shopping</p>
          ...
          Don’t have an account? <span className='text-green-600 font-semibold cursor-pointer hover:underline'><a href="/register">Sign Up</a></span>
          </p>

          <p className='text-center font-medium my-5'>For quick demo login click below</p>
